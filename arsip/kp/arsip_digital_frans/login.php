...
<head>
    ...
    <title>Login Admin | Sistem Informasi Arsip Digital. Kantor Pertanahan</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>Kantor Pertanahan kota Jayapura [ATR-BPN]</p>
            </div>
        </div>   
    </div>
